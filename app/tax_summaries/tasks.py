...
from tax_summaries.logic import assign_asset_tax_summary, assign_option_tax_summary, assign_dividend_tax_summary, assign_general_tax_summary, assign_general_tax_summary_to_dividend_tax_summary
...
def create_tax_summaries():
    ...
    tax_summaries_without_general_summary = DividendTaxSummary.objects.filter(general_tax_summary__isnull=True)
    for tax_summary in tax_summaries_without_general_summary:
        assign_general_tax_summary_to_dividend_tax_summary(tax_summary)
    tax_summaries_without_general_summary = OptionTaxSummary.objects.filter(general_tax_summary__isnull=True)
    for tax_summary in tax_summaries_without_general_summary:
        assign_general_tax_summary(tax_summary)
