    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('Stocks', 'Stocks'), ('Bonds', 'Bonds'), ('Equity and Index Options', 'Options'), ('ETFs', 'ETFs'), ('Forex', 'Forex'), ('Dividends', 'Dividends'), ('Withholding Tax', 'Withholding Tax')], max_length=124)),
